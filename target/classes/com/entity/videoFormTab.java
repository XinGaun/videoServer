...
public class videoFormTab {
	int video_form_id;
	String video_form_name;
	String video_form_class;
	int video_form_status;
	...
	public int getVideo_form_status() {
		return video_form_status;
	}
	public void setVideo_form_status(int video_form_status) {
		this.video_form_status = video_form_status;
	}
