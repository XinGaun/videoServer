...
public class coursesTabController {
	...
	@ResponseBody
	public void upCoursesById(HttpServletRequest request,String courses_id,String courses_name,String courses_video_form_id,String courses_introduce,String courses_pricemoney,String courses_video,MultipartFile image,String courses_qz)  throws Exception{
		System.out.println("controller");
		ctService.upCoursesById( Integer.parseInt(courses_id), courses_name, Integer.parseInt(courses_video_form_id), courses_introduce, courses_pricemoney, courses_video, image,Integer.parseInt(courses_qz));
	}
