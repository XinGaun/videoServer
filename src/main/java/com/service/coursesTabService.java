...
public interface coursesTabService {
	...
	public void addCoursesTab(String courses_name,String courses_introduce,String courses_pricemoney,String courses_video,MultipartFile image,int teacher_id) throws Exception ;
