...
public class AliBigFishSDK {
	...
	public static String SendSMSAli(String data) throws ClientException {
		...
		//替换成你的AK	
		final String accessKeyId = "LTAIfQOlG2PrsiZq";//你的accessKeyId,参考本文档步骤2
		final String accessKeySecret = "06fIk8KuhElXLceKMvCjBApxwISn67";//你的accessKeySecret，参考本文档步骤2
