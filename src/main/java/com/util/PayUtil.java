...
public class PayUtil {
	...
	public static String NOTIFY_URL = "http://www.niceyuwen.com/videoServer/front/pays/notifyPay";

	public static String RETURN_URL = "http://www.niceyuwen.com/videoServer/front/pays/returnPay";

	public static String BASE_URL = "https://pay.paysapi.com";

	public static String TOKEN = "360af2f1cdaf3339b4d75623bd6daf6a";
